...
- (UIDocumentMenuViewController *)documentControllerFrom:(UIViewController *)viewController
    ...
    [menu addOptionWithTitle:@"Photo and video" image:[UIImage imageNamed:@"camera" inBundle:[NSBundle bundleForClass:UCSocialManager.self] compatibleWithTraitCollection:nil] order:UIDocumentMenuOrderFirst handler:^{
